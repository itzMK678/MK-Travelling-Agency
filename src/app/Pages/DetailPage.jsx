...
const DetailPage = () => {
  ...
  return (
    ...
    <div className="min-h-screen flex flex-wrap-reverse bg-gradient-to-r from-white  via-[#FFEABB] to-[#FBC3C1]  p-6 md:p-10 font-sans">
     ...
     <div className="w-1/2 flex flex-wrap-reverse items-center justify-center rounded-l-3xl bg-transparent  shadow-inner overflow-hidden">
  <iframe
  ...
  ></iframe>
      ...
      <div className="w-1/2 rounded-r-3xl text-black  bg-transparent p-6 md:p-8 shadow-2xl flex flex-col gap-6">
