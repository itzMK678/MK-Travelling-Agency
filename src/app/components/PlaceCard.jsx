  ...
  return (
    <div className="bg-white rounded-2xl shadow-md overflow-hidden w-[300px] hover:shadow-xl transition-all duration-300">
      ...
      <div className="flex justify-between gap-2 px-4 pb-4">
        <button className="bg-black text-white px-4 py-2 rounded-full text-sm w-full hover:bg-gray-800 transition">
          View Details
        </button>
        <button className="bg-gray-200 px-4 py-3 rounded-full text-sm w-full hover:bg-gray-300 transition">
          Negotiate
        </button>
      </div>
    </div>
